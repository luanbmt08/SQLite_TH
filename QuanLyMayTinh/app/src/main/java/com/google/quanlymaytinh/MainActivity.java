package com.google.quanlymaytinh;
...
import com.google.quanlymaytinh.Control.Database;
import com.google.quanlymaytinh.Model.Category;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (cursor.getCount()==0){
            db.insertCa("Category 1","DELL");
            db.insertCa("Category 2","ACER");
        ...
        if (cursor.getCount()==0){
            db.insertC("Máy01","Máy tính 1","Category 1");
            db.insertC("Máy02","Máy tính 2","Category 1");
            db.insertC("Máy03","Máy tính 3","Category 1");
            db.insertC("Máy04","Máy tính 4","Category 1");
        }
